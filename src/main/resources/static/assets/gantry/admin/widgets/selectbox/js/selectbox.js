...
},init:function(a){a.addEvents({click:this.toggle.bind(this,a),disable:this.disable.bind(this,a),enable:this.enable.bind(this,a),mousedown:this.preventDefault.bindWithEvent(this,a),onselectstart:this.preventDefault.bindWithEvent(this,a),mouseenter:this.enter.bind(this,a),mouseleave:this.leave.bind(this,a)},this);
...
$clear(a.timer);},leave:function(a){var b=this.getObjects(a);$clear(a.timer);a.timer=this.hide.delay(500,this,b);},show:function(a){a.dropdown.setStyle("visibility","visible");
...
},disable:function(a){$clear(a.timer);this.hide(this.getObjects(a));a.addClass("disabled");},preventDefault:function(b,a){b.stop();return false;}});window.addEvent("domready",function(){window.selectboxes=new SelectBox();
});