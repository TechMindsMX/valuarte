...
}));});i=$A([o]).combine(j).flatten();i.each(function(q){if(q.hasClass("parent")){var r=q.getLast();if(r.get("tag")=="a"){r.storedLink=r.href;r.setProperty("href","#"+q.id.replace("idrops-","idown-"));
